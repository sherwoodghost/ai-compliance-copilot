...
const FILENAME_PATTERNS: PatternEntry[] = [
  ...
  { pattern: /hipaa|phi.?policy|protected.?health/i, type: 'policy', frameworks: ['HIPAA'], confidence: 92, controls: [] },
  { pattern: /baa|business.?associate/i,   type: 'policy',      frameworks: ['HIPAA'],           confidence: 92, controls: ['HIPAA-164.308-b1'] },
  { pattern: /minimum.?necessary|safeguard/i, type: 'policy',   frameworks: ['HIPAA'],           confidence: 87, controls: ['HIPAA-164.312-a1'] },
  // PCI-DSS-specific patterns
  { pattern: /pci|cardholder.?data|payment.?card/i, type: 'policy', frameworks: ['PCI_DSS'],    confidence: 92, controls: [] },
  { pattern: /card.?data.?environment|cde/i, type: 'audit_report', frameworks: ['PCI_DSS'],      confidence: 90, controls: [] },
  { pattern: /qsa.?report|roc|saq/i,        type: 'audit_report', frameworks: ['PCI_DSS'],       confidence: 94, controls: [] },
  // FedRAMP-specific patterns
  { pattern: /fedramp|ato|authority.?to.?operate/i, type: 'audit_report', frameworks: ['FEDRAMP'], confidence: 92, controls: [] },
  { pattern: /system.?security.?plan|ssp/i, type: 'policy',     frameworks: ['FEDRAMP'],         confidence: 90, controls: [] },
  { pattern: /poam|plan.?of.?action/i,      type: 'report',      frameworks: ['FEDRAMP'],         confidence: 90, controls: [] },
  // NIST CSF-specific patterns
  { pattern: /nist.?csf|cybersecurity.?framework/i, type: 'policy', frameworks: ['NIST_CSF'],    confidence: 90, controls: [] },
  // ISO 14001 / 45001 patterns
  { pattern: /iso.?14001|environmental.?aspect/i,  type: 'policy', frameworks: ['ISO14001'],     confidence: 90, controls: [] },
  { pattern: /iso.?45001|ohs|occupational.?health/i, type: 'policy', frameworks: ['ISO45001'],   confidence: 90, controls: [] },
  // Cross-framework patterns
  { pattern: /security.?policy|infosec/i,  type: 'policy',      frameworks: ['ISO27001','SOC2','HIPAA'], confidence: 90, controls: ['A.5.1','CC2.1'] },
  { pattern: /incident.?response/i,        type: 'policy',      frameworks: ['ISO27001','SOC2','HIPAA'], confidence: 88, controls: ['A.5.24','CC7.3'] },
  { pattern: /business.?continuity|bcp|bcdr/i, type: 'policy',  frameworks: ['ISO27001','SOC2'], confidence: 88, controls: ['A.5.29','A1.2'] },
  { pattern: /risk.?assessment|risk.?register/i, type: 'policy', frameworks: ['ISO27001','SOC2','HIPAA'], confidence: 90, controls: ['A.5.9','CC3.2'] },
  { pattern: /vendor|supplier|third.?party/i, type: 'policy',   frameworks: ['ISO27001','SOC2','PCI_DSS'], confidence: 85, controls: ['A.5.19','CC9.2'] },
  { pattern: /training|awareness|phishing/i,   type: 'training_record', frameworks: ['ISO27001','SOC2','HIPAA'], confidence: 88, controls: ['A.6.3','CC1.4'] },
  { pattern: /change.?management|change.?control/i, type: 'policy', frameworks: ['ISO27001','SOC2','PCI_DSS'], confidence: 88, controls: ['A.8.32','CC8.1'] },
  ...
  { pattern: /data.?retention/i,             type: 'policy',    frameworks: ['GDPR','ISO27001','HIPAA'], confidence: 88, controls: ['GDPR-Art-5-1','A.5.33'] },
  { pattern: /encryption|cryptograph/i,      type: 'policy',    frameworks: ['ISO27001','GDPR','HIPAA','PCI_DSS'], confidence: 87, controls: ['A.8.24','GDPR-Art-32-1'] },
  { pattern: /mfa|multi.?factor|2fa/i,       type: 'config_screenshot', frameworks: ['SOC2','ISO27001','HIPAA','PCI_DSS'], confidence: 88, controls: ['CC6.1','A.8.5'] },
  { pattern: /backup|disaster.?recovery/i,   type: 'audit_report', frameworks: ['ISO27001','SOC2','HIPAA'], confidence: 87, controls: ['A.8.13','A1.2'] },
];
...
const FOLDER_PATTERNS: PatternEntry[] = [
  ...
  { pattern: /\/hipaa\//i,       type: 'policy',        frameworks: ['HIPAA'],      confidence: 85, controls: [] },
  { pattern: /\/pci.?dss\//i,    type: 'policy',        frameworks: ['PCI_DSS'],    confidence: 85, controls: [] },
  { pattern: /\/fedramp\//i,     type: 'audit_report',  frameworks: ['FEDRAMP'],    confidence: 85, controls: [] },
  { pattern: /\/nist.?csf\//i,   type: 'policy',        frameworks: ['NIST_CSF'],   confidence: 85, controls: [] },
  { pattern: /\/iso.?14001\//i,  type: 'policy',        frameworks: ['ISO14001'],   confidence: 85, controls: [] },
  { pattern: /\/iso.?45001\//i,  type: 'policy',        frameworks: ['ISO45001'],   confidence: 85, controls: [] },
