      ...
      >
        ...
        <div className="hidden sm:flex items-center gap-5 shrink-0 text-right">
          <div>
            ...
            <p className="text-sm font-semibold text-gray-300">{prompt.usageCount.toLocaleString()}</p>
          </div>
          <div>
            <p className="text-xs text-gray-600">Avg cost</p>
            <p className="text-sm font-semibold text-amber-400">${prompt.avgCostUsd.toFixed(3)}</p>
          </div>
          {prompt.lastUsedAt && (
            <div>
